...
rm -f "$EXT_DIR/zot-data-sync@0und.com.xpi"

# Copy new XPI
cp "$XPI" "$EXT_DIR/zot-data-sync@0und.com.xpi"
echo "Installed: $EXT_DIR/zot-data-sync@0und.com.xpi"
ls -lh "$EXT_DIR/zot-data-sync@0und.com.xpi"
